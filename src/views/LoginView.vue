<template>
    <div
        class="min-h-screen bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
                ...
                <div class="space-y-3">
                    <button
                        class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-colors group">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white text-gray-500">Or continue with username</span>
                    </div>
                </div>
                <form class="space-y-4" @submit.prevent="handleLogin">
                    <div>
                        ...
                        <input id="username" v-model="username" name="username" type="text" required
                            ...
                            class="appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div class="space-y-1 text-xs text-blue-800">
                        <p><span class="font-medium">Admin:</span> username: <code
                                class="bg-blue-100 px-1 rounded">admin</code> / password: <code
                                class="bg-blue-100 px-1 rounded">admin123</code></p>
                        <p><span class="font-medium">User:</span> username: <code
                                class="bg-blue-100 px-1 rounded">user</code> / password: <code
                                class="bg-blue-100 px-1 rounded">user123</code></p>
                    </div>
                </div>
                <div class="text-center">

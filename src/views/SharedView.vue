                ...
                <div class="p-3 space-y-2">
                    <div v-for="i in 8" :key="i"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Shared_Document_{{ i }}.xlsx
                            </p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Shared by user@example.com • 1.2 MB</p>
                        </div>
                        <div class="flex items-center space-x-2">
                            <span
                                class="text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-1 rounded">Can
                                Edit</span>
                            <button

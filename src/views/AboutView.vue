  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">Information about Control Center Cloud</p>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        <div class="max-w-3xl">
          <h2 class="text-xl font-semibold text-gray-900 mb-4">Control Center Cloud</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div>
              ...
              <ul class="space-y-2 text-sm text-gray-600">
                <li class="flex items-center">
                  <div class="w-1.5 h-1.5 bg-primary-600 rounded-full mr-3"></div>
            ...
            <div>
              <h3 class="text-lg font-medium text-gray-900 mb-3">Technology</h3>
              <ul class="space-y-2 text-sm text-gray-600">
                <li class="flex items-center">
                  <div class="w-1.5 h-1.5 bg-primary-600 rounded-full mr-3"></div>
                  Vue 3 + TypeScript

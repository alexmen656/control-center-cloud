<template>
    <div class="min-h-screen bg-white dark:bg-gray-950">
        <div class="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800">
            ...
            <header class="w-full px-6 py-4 mb-16">
                <div class="max-w-7xl mx-auto flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div @click="$router.push('/')"
                            class="flex-shrink-0 flex items-center logo-container cursor-pointer">
                            <img class="logo-image" src="../assets/logo.png" alt="Logo">
                            <span class="logo-text">Control Cloud</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <router-link to="/login"
                            class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 px-4 py-2 text-sm font-semibold transition-colors">
                            Sign in
                        </router-link>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div class="bg-gradient-to-br from-primary-600 to-primary-700 rounded-3xl p-12 shadow-2xl">
                    ...
                    <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                        Start storing your files securely today. No credit card required, no hidden costs. Just sign up
                        and start using Control Cloud.
                    </p>
                    <ul class="space-y-4 text-left max-w-md mx-auto mb-8">
                        <li class="flex items-start text-white">
                            ...
                            <span class="text-lg">1 GB secure storage space</span>
                        </li>
                        <li class="flex items-start text-white">
                            <svg class="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <span class="text-lg">File sharing capabilities</span>
                        </li>
                        <li class="flex items-start text-white">
                            <svg class="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <span class="text-lg">Access from any device</span>
                        </li>
                        <li class="flex items-start text-white">
                            <svg class="w-6 h-6 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <span class="text-lg">Forever free - no expiration</span>
                        </li>
                    </ul>
                    <router-link to="/signup"
                        class="inline-block bg-white text-primary-700 hover:bg-primary-50 px-10 py-4 rounded-xl text-lg font-bold transition-all shadow-xl hover:shadow-2xl hover:scale-105">
                        Create Free Account
                    </router-link>
                </div>
            </div>
